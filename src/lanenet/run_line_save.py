...
def inference(model, image):
    ...
    binary_img[0:35, :] = 0  # (0~40행)을 무시 - 불필요한 영역 제거
...
def main():
    ...
    video_path = './final_videos/lama_mud_v3_30fps.mp4'  # 입력 비디오 경로
    ...
    output_path = './lanenet_mud_v3_30fps.mp4'
    ...
    while video_capture.isOpened():  # 비디오 프레임 반복
        ...
        if ret:
            ...
            video_writer.write(processed_frame)  # 처리된 프레임을 출력 비디오에 씀
            cv2.imshow('Processed Frame', processed_frame)  # 처리된 프레임을 화면에 출력
